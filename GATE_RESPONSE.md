...
- The predecessor archive [`baselines/P10-Core-v0.2.0-composition.zip`](baselines/P10-Core-v0.2.0-composition.zip) is strictly frozen and immutable with digest `a86501aab0f35d055087d5793b897260635b441fb51d12dc6d99cd0229a0fc89`. The file `BASELINE_MANIFEST.sha256` contained within it is a mislabelled v0.1.0 seed snapshot from initial packaging; adhering to strict frozen-rule doctrine, the historical archive is **not modified in place**. The verified, repo-relative manifest for all 15 predecessor files is carried externally in [`manifests/SHA256SUMS_v0.2.0-composition`](manifests/SHA256SUMS_v0.2.0-composition).
